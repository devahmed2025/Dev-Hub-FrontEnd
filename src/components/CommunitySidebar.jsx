...
const CommunitySidebar = ({ isDarkMode, onTagSelect, selectedTag, posts }) => {
  const dispatch = useDispatch();
  const {
    courses,
    status: courseStatus,
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <p
                className={`text-lg font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}
              >
                {communityInsights.thisWeekPosts}
              </p>
            </div>
            <div>
              <p
              ...
              <p
                className={`text-lg font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}
              >
                {communityInsights.totalEngagement}
              </p>
            </div>
            <div>
              <p
              ...
              <p
                className={`text-lg font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}
              >
                {communityInsights.averageEngagement}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3">
            {activeUsers.map((userStats, index) => (
              <div key={userStats.user._id} className="flex items-center gap-3">
                <div className="relative">
                  <img
                    src={userStats.user.profilePhoto || '/default-avatar.png'}
                    alt={userStats.user.name}
                    className="w-8 h-8 rounded-full object-cover"
                    loading="lazy"
                  />
